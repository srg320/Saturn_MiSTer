...
set_false_path -to [get_registers {emu:emu|Saturn:saturn|VDP1:VDP1|*_GHCOLOR_DR[*] emu:emu|Saturn:saturn|VDP1:VDP1|*_GHCOLOR_DG[*] emu:emu|Saturn:saturn|VDP1:VDP1|*_GHCOLOR_DB[*]}]